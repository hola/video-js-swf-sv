package flex.util.ui.throbber {
    ...
    public class SimpleThrobber extends Sprite {
         ...
         */
        public var colors:Array = [0x4f7e90, 0x4a7987, 0x44757f, 0x345e63, 0x294651];
         ...
         */
        public function SimpleThrobber(w:int = 32, h:int = 32, lineThickness:int = 3) {
            super();
            this.w = w;
            this.h = h;
        ...
        protected function drawLines():void {
            ...
            if ((radius > 0) && (lineThickness > 0) && (lineAlpha > 0)) {
                ...
                while (angle < maxAngle) {
                    ...
                    g.lineStyle(lineThickness, color, lineAlpha, true, null, CapsStyle.ROUND);
